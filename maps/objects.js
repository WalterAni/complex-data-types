...
let indexOfTV = patient.indexOf("TV")
...
delete clearMe.name
delete clearMe.age
delete clearMe.pasrtConditions
...
let spotsLeft = (ICUWard.rooml.capacity - ICUWard.room1.patients.length) + (ICUWard.room2.capacity - ICUWard.room2.patients.length)
...
let sizeInAUs = solarSystem.properties.size / solarSystem.properties.planets[2]
let planets = solarSystem.properties.planets
let argonOnEarthLikeMars = solarSystem.properties.planets[2].atmosphere.argon = planets[3].atmosphere.argon
